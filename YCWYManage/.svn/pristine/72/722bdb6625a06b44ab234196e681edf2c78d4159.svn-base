...
else
{
 ...
 %>
	...
	<select id="Bu_id" class="input_txt" name="Bu_id" class="input_txt" onchange="select_danyuan(this,'<%=dividdy %>','<%=request.getContextPath()+"/YCWYPage/BackPage/quarters/charge_select_dy.jsp"%>','<%=ts_id %>','<%=Es_id%>')" >
