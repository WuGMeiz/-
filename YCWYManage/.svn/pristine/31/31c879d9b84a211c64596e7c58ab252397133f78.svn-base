			...
			<table style="display:block; width:800px; margin:0 auto;">
				<tr  height="45">
					...
					<td width="200">
						...
						<input class="input_txt" id="sfname" name="sfname" type="hidden" maxlength="100" value="供暖费"/>
					</td>
				</tr>
				<tr height="45">
				...
				<tr height="45">
				   <td align="right">备注：</td>
					<td>
						...
						<input class="hidden" id="guRatio" name="guRatio" type="text" maxlength="100"/>
					</td>
					<!-- <td align="right">故障比例：</td> -->
				...
				<tr height="45">
					<td  align="center" colspan="8">
						...
						onclick="TB_GongReItemadd( '<%=request.getContextPath()%>/TB_Itemadd?arg=2','<%=request.getContextPath()+"/YCWYPage/BackPage/calculate/GongRe_item.jsp"%>');" value="提交">					
						&emsp;
