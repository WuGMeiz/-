			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr height="45">
					...
					<td align="left"  >
						...
						onchange="select_louyu(this,'louyu','<%=request.getContextPath()+"/YCWYPage/BackPage/print/charge_select_ly.jsp"%>','<%=ts_id %>')">
					...
					<td align="center" ><input  type="button" class="submit_input" value="查询" onclick="select_print_orders('select_gue_orders','<%=request.getContextPath()+"/YCWYPage/BackPage/print/print_cx_see.jsp"%>','<%=ts_id%>')"/></td>
				</tr>
