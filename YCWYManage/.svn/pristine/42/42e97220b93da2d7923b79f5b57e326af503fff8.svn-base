			...
			<table style="display:block; width:800px; margin:0 auto;">
				<tr  height="45">
					...
					<td width="200">
					    <select class="input_txt" id="sftype" name="sftype">
							...
							<option value="7" selected="selected">按度计算</option>
							<option value="8">按固定金额计算</option>
						</select>
						<input class="input_txt" id="sfname" name="sfname" type="hidden"  value="电费"/>
					</td>
				</tr>
				...
				<tr height="45">
					<td  align="center" colspan="8">
						...
						onclick="TB_ElectricItemadd('<%=request.getContextPath()%>/TB_Itemadd?arg=6','<%=request.getContextPath()+"/YCWYPage/BackPage/calculate/Electric_item.jsp"%>');" value="提交">					
						&emsp;
