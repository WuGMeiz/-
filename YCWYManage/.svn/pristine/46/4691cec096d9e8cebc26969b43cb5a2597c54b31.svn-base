			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr height="45">
					...
					<td align="left"  >
						...
						onchange="select_louyuLD2(this,'louyu','<%=request.getContextPath()+"/YCWYPage/BackPage/artificial/charge_select_ly.jsp"%>','<%=ts_id %>','jfxdiv','<%=request.getContextPath()+"/YCWYPage/BackPage/artificial/jfx3.jsp"%>','fzrid','<%=request.getContextPath()+"/YCWYPage/BackPage/artificial/charge_select_fzr.jsp"%>');">
				...
				<tr height="45">
				   <td align="right" width="80">收费项:</td> 
					<td>
						<div id="jfxdiv">
							<jsp:include page="/YCWYPage/BackPage/artificial/jfx3.jsp" flush="true"></jsp:include>
						</div>
					</td>
				   ...
				   <td align="right" width="80">业主姓名:</td>
					<td align="left"  >
						<input type="text"  style="width: 80%;"  class="input_txt" id="OwnerName" name="OwnerName" />
					</td>
					
				 </tr>
					<tr>
					<td align="right" width="80">收费员:</td> 
					<td>
						<div id="fzrid">
					...
					<td align="left"  colspan="4"   >
					       <input type="text" id="timesk" name="timesk" style="width: 40%;" class="input_txt"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})" readonly="readonly"/>至
					       <input type="text" id="timesj" name="timesj" style="width: 40%;" class="input_txt"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})" readonly="readonly"/>
						<!-- 
							<input type="text" style="width: 45%;" class="input_txt" id="timesk" name="timesk" onclick="showcalendar(event,this);" onfocus="showcalendar(event, this);if(this.value=='0000-00-00')this.value=''" readonly="readonly" />至
							<input type="text" style="width: 45%;" class="input_txt" id="timesj" name="timesj" onclick="showcalendar(event,this);" onfocus="showcalendar(event, this);if(this.value=='0000-00-00')this.value=''" readonly="readonly" /> -->
					</td>
					<td align="center">
					      <input  type="button" class="submit_input" value="查询" onclick="select_gue_orders2('select_gue_orders','<%=request.getContextPath()+"/YCWYPage/BackPage/artificial/charge_self_see.jsp"%>','<%=ts_id%>')"/>
					</td>
					</tr>
			</table>
<!-- 等待刷新的div层 -->
