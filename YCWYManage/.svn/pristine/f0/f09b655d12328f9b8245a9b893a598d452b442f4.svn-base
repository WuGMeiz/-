			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr height="45">
					...
					<td align="right" width="10%">类型：</td>
		             <td align="left" width="20%">
						<select id="tousuType" name="tousuType" class="input_txt">
					...
					<td align="center">
                    	<input class="submit_input" name="chaxun" value=" 查 询 " onclick="selTou('show_update','<%=request.getContextPath()+"/YCWYPage/BackPage/ProperService/tousu_update.jsp"%>');return false;" type="button" />
                    </td>
