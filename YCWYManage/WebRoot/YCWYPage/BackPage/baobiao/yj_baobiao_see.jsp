...
<%	
	...
	String Condition=" 1=1 and a.status='1' and b.status='1'and c.status='1' and d.status='1' and e.status='1' and a.orderType='2' and payStatus='1' "+ts_id+Es_id+create_time+EhNumber+OwnerName+itemName;
  ...
  <body>
  	...
  	<table align="center"  class="tableList" width="100%">
		...
		<% if(list.size()>0){
	  	...
	  	<tr height="45"><td height="45" align="center" colspan="9">未查询到订单信息！！！</td></tr>
		<%} %>
		</tbody>
  	</table>
<%
String url = request.getContextPath()+"/YCWYPage/BackPage/baobiao/yj_baobiao_see.jsp";
%>
<div class="pages">
	<jsp:include page="/YCWYPage/BackPage/charge/page.jsp">
		...
		<jsp:param name="divid" value="select_zzjf"/>
	</jsp:include>
</div>
<!-- 等待刷新的div层 -->
