		...
		<div class="addBox">
			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr height="45">
					...
					<td align="center" ><input  type="button" class="submit_input" value="查询" onclick="select_orders('select_orders','<%=request.getContextPath()+"/YCWYPage/BackPage/baobiao/cj_baobiao_see.jsp"%>','<%=ts_id%>')"/></td>
				</tr>
