...
%>
		<select id="Bu_id" name="Bu_id"  class="input_txt" onchange="select_unite(this,'sl_unite','<%=request.getContextPath()+"/YCWYPage/BackPage/charge/charge_select_unite.jsp"%>','<%=ts_id %>')">
				<%
				if(list2.size()>0){
				%>
