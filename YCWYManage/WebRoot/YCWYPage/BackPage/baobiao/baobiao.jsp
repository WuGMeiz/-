...
%>  
	<table width="100%" height="100%" >
		<tr  height="45">
			...
			<td align="right" width="80">查询时间：</td>
			<td colspan="3">
			...
			<td>
				<input type="button" class="submit_input" value="查询" onclick="select_baobiao('select_baobiao','<%=request.getContextPath()+"/YCWYPage/BackPage/baobiao/tj_baobiao_see.jsp"%>','<%=ts_id%>')">
			</td>
		</tr>
	</table>
<div id="select_baobiao"></div>
<%
}
%>