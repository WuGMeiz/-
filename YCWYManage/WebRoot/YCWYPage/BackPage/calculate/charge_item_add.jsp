...
<div class="div_app_showTite"><b title="关闭" onclick="close_tanchu_div('div_app_show');">×</b></div>
 		<font style="color: red;">温馨提示：添加缴费项名称涉及到水费、电费、燃气费请严格按照（"水费","电费","燃气费"）标准字眼进行添加，否则抄表费用录入菜单将无法识别费用类别。</font>
		<form name="form1" style="display:block;">
			<table style="display:block; width:800px; margin:0 auto;">
				<tr  height="45">
					...
					<td align="right" width="150">收费名称：<font style="color: red;">*</font></td>
					<td width="200">
						<input class="input_txt" id="sfname" name="sfname" type="text" maxlength="100"/>
					</td>
				</tr>
				<tr height="45">
				...
				<tr height="45">
					<td  align="center" colspan="8">
						...
						onclick="TB_Item_add( '<%=request.getContextPath()%>/WyTBPay_Item_add','<%=request.getContextPath()+"/YCWYPage/BackPage/calculate/charge_item.jsp"%>');" value="提交">					
						&emsp;
