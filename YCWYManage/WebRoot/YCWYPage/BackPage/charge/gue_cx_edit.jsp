...
<%	
	...
	TB_Estate_Order order = new MyTB_Estate_Order().selectGE_orders_mx(Eo_id); 
%>
  <body>
<!-- 弹出层关闭按钮 -->
	...
	<table width="100%" class="tableTbody" >
		...
		<tr height="45">
			<td  align="center" colspan="8">
				<input type="button"  class="submit_input" value="修改" onclick="update_orders('<%=request.getContextPath()+"/TB_Estate_Order_upServlrt"%>','<%=request.getContextPath()+"/YCWYPage/BackPage/charge/gue_cx_see.jsp?type=1"%>','<%=ts_id%>','select_gue_orders','1');">					
			</td>
		</tr>
	</table>
</div>
