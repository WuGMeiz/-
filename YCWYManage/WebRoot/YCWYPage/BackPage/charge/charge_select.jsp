			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr height="45">
					...
					<td align="left"  >
						...
						onchange="select_louyuLD2(this,'louyu','<%=request.getContextPath()+"/YCWYPage/BackPage/charge/charge_select_ly.jsp"%>','<%=ts_id %>','jfxdiv','<%=request.getContextPath()+"/YCWYPage/BackPage/charge/jfx1.jsp"%>','fzrid','<%=request.getContextPath()+"/YCWYPage/BackPage/charge/charge_select_fzr.jsp"%>');" >
					...
					<td align="left"  >
						<input type="text" style="width: 80%;"  class="input_txt" id="EhNumber" name="EhNumber" />
					</td>
					</tr>
					<tr height="45">
				...
				<tr>
					...
					<td align="left"  colspan="4">
						...
						<!-- <input type="text" style="width: 43%;" class="input_txt" id="timesk" name="timesk" onclick="showcalendar(event,this);" onfocus="showcalendar(event, this);if(this.value=='0000-00-00')this.value=''" readonly="readonly" />至
						<input type="text" style="width: 43%;" class="input_txt" id="timesj" name="timesj" onclick="showcalendar(event,this);" onfocus="showcalendar(event, this);if(this.value=='0000-00-00')this.value=''" readonly="readonly" /> -->
					</td>
					<td align="center" >
					    <input  type="button" class="submit_input" value="查询" onclick="select_orders('select_orders','<%=request.getContextPath()+"/YCWYPage/BackPage/charge/charge_select_see.jsp"%>','<%=ts_id%>')"/>
					</td>
				</tr>
			</table>
<!-- 等待刷新的div层 -->
<div id="select_orders" ></div>
<!-- 查看修改读取层 -->  
