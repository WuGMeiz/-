			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				...
				<tr height="45">
				 ...
				 <td align="right" width="80">支付时间:</td>
					...
					<td align="center" ><input  type="button" class="submit_input" value="查询" onclick="select_gue_orders('select_gue_orders','<%=request.getContextPath()+"/YCWYPage/BackPage/charge/gue_cx_see.jsp"%>','<%=ts_id%>')"/></td>
