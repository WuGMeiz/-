		...
		<div class="addBox">
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr height="45">
                    ...
                    <td align="right">
                      <input class="submit_input" type="button" value="添加" onclick="return addRepPeo('showmain','<%=request.getContextPath()%>/TB_Estate_RepPeopleServlet?arg=1','<%=request.getContextPath()%>/YCWYPage/BackPage/ProperService/repairPeo.jsp');">
                    </td>
					<td align="right">
                    	<input class="submit_input" name="chaxun" value=" 查 询 " onclick="selRepairPeo('show_update','<%=request.getContextPath()+"/YCWYPage/BackPage/ProperService/repairPeo_update.jsp"%>');return false;" type="button" />
                    </td>
