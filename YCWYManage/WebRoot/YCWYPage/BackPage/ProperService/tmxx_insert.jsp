...
<div class="tables" id="show1">
<iframe id="pjname" name="pjname" scrolling="no" width="100%" height="450" frameborder="0" src="<%=request.getContextPath()+"/YCWYPage/BackPage/ProperService/tmxx_insert2.jsp"%>"></iframe>
</div>
<%}%>
