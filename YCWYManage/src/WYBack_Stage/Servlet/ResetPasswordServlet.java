    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            else
            {
                ...
                String tablename=session.getAttribute("TABLENAME").toString();//管理员属于哪个表
                if (new MyTB_SEV_USER().resetPassword(tu_id, resetPassword,tablename)) 
                {
                    String l_content="给管理员用户账号："+new MyTB_SEV_USER().getuserid(tu_id, tablename)+"重置密码。";
