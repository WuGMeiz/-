...
public class Tb_Estate_Order_rgsf extends HttpServlet {
...
//					if(Limited>=Double.parseDouble(total)){
						if(LimitNumber>num){
							String sql = "insert into TB_Estate_Order (ts_id,a_id,Es_id,Bu_id,Eh_id,orderType,payItem,total,creat_time,payStatus,status,pay_time,total_sj,payType,bankid,tu_id,total_znj) " +
									"values ('"+ts_id+"','"+a_id+"','"+Es_id+"','"+Bu_id+"','"+str+"','2','"+payItem+"','"+total+"','"+time+"','1','1','"+time+"','"+total+"','"+payType+"','"+bankid+"','"+tu_id+"','0')";
							...
							if(returnstr.equals("")){		
								out.print("ssok-收费成功，如需打印，请点击自助缴费查询模块打印收据！");
							}else{
