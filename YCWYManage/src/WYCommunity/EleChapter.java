...
public class EleChapter {
	
	public static BufferedImage startGraphics2D(String message, int WIDTH,int HEIGHT ){  
        // 定义图像buffer         
	 ...
	 /* public static void main(String[] args) {
	    	BufferedImage image = startGraphics2D("山西丽华物业管理有限公司",400,400);
	        try {
	            String filePath = "D:\\dzpj\\"+new Date().getTime()+".png";
